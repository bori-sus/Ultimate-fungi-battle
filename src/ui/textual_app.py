...
class BoardCell(Widget):
    ...
    def _card_size_for(width: int, height: int = 0) -> tuple[int, int]:
        ...
        Карты ВЕРТИКАЛЬНЫЕ (как игральные), но ШИРОКИЕ для удобства.
        Соотношение сторон height/width:
            4×7: 1.75 — узкое но стандартное
            5×7: 1.40 — стандарт Magic card (63×88)
            5×8: 1.60 — шире
            6×8: 1.33 — широкое

        Размеры:
            40×20:  3×4  h/w=1.33  — мини
            40×30:  3×5  h/w=1.67
            60×30:  3×5  h/w=1.67
            80×24:  3×4  h/w=1.33  — узкий стандарт
            100×40: 5×7  h/w=1.40  ✅ Magic card стандарт, ШИРЕ!
            120×40: 5×7  h/w=1.40  ✅
            130×50: 6×8  h/w=1.33  — широкий
        """
        ...
        if height < 22:
            ...
            return 3, 5   # 60×30, 40×30
        elif height < 42:
            return 5, 7   # 100×40, 120×40 ✅ Magic card
        else:
            return 6, 8   # 130×50 большой
